...
function BuyButton() {
    ...
    return !user ? (
        <SignInButton forceRedirectUrl={'checkout-redirect'}>
            <Button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl border border-blue-500/20 bg-blue-500/10 py-1 px-2 text-base font-medium text-blue-600 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_10px_28px_rgba(15,23,42,0.06)] backdrop-blur-xl transition-all duration-300 hover:bg-blue-500/15 hover:border-blue-500/30 hover:text-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/40 disabled:pointer-events-none disabled:opacity-50">
                Upgrade to Premium
            </Button>
        </SignInButton>
    ) : (
